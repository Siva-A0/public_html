    ...
    if (!app_validate_csrf_token($_POST['csrf_token'] ?? '')) {
        ...
        if ($batchId <= 0 || $classId <= 0 || $sectionId <= 0) {
            ...
            if ($ok !== false) {
                ...
                header('Location: ' . BASE_URL . '/admin/students/students.php');
                exit;
            }
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-3">
        ...
        <a href="<?php echo BASE_URL; ?>/admin/students/students.php" class="btn btn-outline-secondary">Back</a>
    </div>
        ...
        <div class="card-body" style="max-width: 820px;">
            ...
            <form method="post" action="">
                ...
                <div class="mt-4 d-flex gap-2">
                    ...
                    <a class="btn btn-outline-secondary" href="<?php echo BASE_URL; ?>/admin/students/students.php">Cancel</a>
                </div>
            </form>
        </div>
    </div>
...
(function(){
    ...
    function refreshSections(){
        ...
        fetch('<?php echo BASE_URL; ?>/admin/students/sections.php?batchId=' + encodeURIComponent(batchId) + '&classId=' + encodeURIComponent(classId), {
