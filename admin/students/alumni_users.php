...
function admin_alumni_redirect_self(){
    $qs = $_SERVER['QUERY_STRING'] ?? '';
    $url = BASE_URL . '/admin/students/alumni_users.php' . ($qs !== '' ? ('?' . $qs) : '');
    header('Location: ' . $url);
    exit;
}
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-3">
        ...
        <div class="d-flex flex-wrap gap-2">
            <a href="<?php echo BASE_URL; ?>/admin/students/manage_users.php" class="btn btn-outline-secondary">Back to Users</a>
        </div>
    </div>
        ...
        <div class="card-body">
            <form method="get" class="row g-3 align-items-end">
                ...
                <div class="col-12 d-flex justify-content-end gap-2">
                    <a class="btn btn-outline-secondary" href="<?php echo BASE_URL; ?>/admin/students/alumni_users.php">Reset</a>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="btn-group btn-group-sm" role="group">
                                            <a class="btn btn-outline-primary" href="<?php echo BASE_URL; ?>/admin/students/edit_user.php?id=<?php echo $uId; ?>">Edit</a>
                                            <?php if ($statusVal === 1) { ?>
