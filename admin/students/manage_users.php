...
function admin_users_redirect_self(){
    ...
    $url = BASE_URL . '/admin/students/manage_users.php' . ($qs !== '' ? ('?' . $qs) : '');
    header('Location: ' . $url);
    exit;
}
    ...
    <div class="manage-users-page">
        <div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-3">
            ...
            <div class="d-flex flex-wrap gap-2">
                <a href="<?php echo BASE_URL; ?>/admin/students/users.php" class="btn btn-outline-secondary">Pending Approvals</a>
            </div>
        </div>
            ...
            <div class="card-body">
                <form method="get" class="row g-3 align-items-end">
                    ...
                    <div class="col-12 d-flex justify-content-end gap-2">
                        <a class="btn btn-outline-secondary" href="<?php echo BASE_URL; ?>/admin/students/manage_users.php">Reset</a>
