        ...
        <div class="col-lg-3">
            <aside class="user-side-panel" id="user-sidebar">
                ...
                <nav class="user-side-nav user-side-nav-main">
                    ...
                    <a class="user-side-link<?php echo userNavActive('certifications', $userActivePage); ?>" href="<?php echo BASE_URL; ?>/public/pages/user/certifications.php"><i class="bi bi-patch-check user-side-link-icon"></i><span>Upload Certification</span></a>
                    <a class="user-side-link<?php echo userNavActive('my_certifications', $userActivePage); ?>" href="<?php echo BASE_URL; ?>/public/pages/user/my_certifications.php"><i class="bi bi-file-earmark-medical user-side-link-icon"></i><span>My Certifications</span></a>
