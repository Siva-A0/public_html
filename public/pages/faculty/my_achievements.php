...
$achievements = $fcObj->getFacultyAchievements(TB_ACHIEVEMENTS, (string)$staffRows[0]['id']);
$documentCount = 0;
$textCount = 0;
...
<div class="faculty-page">
    <section class="faculty-hero">
        ...
        <div class="faculty-meta-line">
            ...
            <span class="faculty-meta-pill"><strong>Text</strong> <?php echo $textCount; ?></span>
        </div>
    </section>
                ...
                <?php foreach ($achievements as $row) { ?>
                    ...
                    <article class="faculty-achievement-card">
                        <div class="faculty-achievement-top">
                            ...
                            <span class="faculty-type-badge"><?php echo htmlspecialchars($typeLabel, ENT_QUOTES, 'UTF-8'); ?></span>
                        </div>
